...
func (app *application) createPostForm(
	w http.ResponseWriter,
	r *http.Request,
) {
	app.render(
...
func (app *application) createPost(
	w http.ResponseWriter,
	r *http.Request,
) {
	err := r.ParseForm()
...
func (app *application) userProfile(
	w http.ResponseWriter,
	r *http.Request,
) {
	userID := app.session.GetInt(
		r,
		"authenticatedUserID",
	)
...
func (app *application) changePasswordForm(
	w http.ResponseWriter,
	r *http.Request,
) {
	app.render(
